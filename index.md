...
STANDARD — дневной бюджет может исчерпаться, а показы завершиться ранее окончания дня.</td>
    ...
    <tr>
	<td>SearchBidStrategyType</td><td>Стратегия показа объявлений в поисковой сети Яндекса</td>
    </tr>
    <tr>
	<td>NetworkBidStrategyType</td><td>Стратегия показа объявлений в рекламной сети Яндекса</td>
    </tr>
</table>
